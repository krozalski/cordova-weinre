...
var HttpChannelHandler, Version, channelManager, checkForDeath, checkHost, deathTimeout, dns, dumpingHandler, express, fs, getStaticWebDir, getVersion, https, jsonBodyParser, net, path, processOptions, run2, serviceManager, startDeathWatcher, startServer, utils, _;
...
startServer = function() {
  var app, clientHandler, favIcon, httpsOptions, options, protocol, staticCacheOptions, targetHandler, _ref;
  options = utils.options;
  ...
  protocol = (_ref = options.https === 'true') != null ? _ref : {
    'http': 'https'
  };
